  ...
  BootstrapDualListbox.prototype = {
    init: function () {
      ...
      this.container = $('' +
        ...
        '     <button id="myButton" type="button" class="btn btn-sm clear1" style="float:right!important;"></button>' +
        '   </span>' +
        '   <input class="form-control filter" type="text">' +
        '   <div class="btn-group buttons">' +
        '     <button id="myButton" type="button" class="btn moveall"></button>' +
        '     <button id="myButton" type="button" class="btn move"></button>' +
        '   </div>' +
        ...
        '   <span class="info-container">' +
        '     <span class="info"></span>' +
        '     <button id="myButton" type="button" class="btn btn-sm clear2" style="float:right!important;"></button>' +
        '   </span>' +
        '   <input class="form-control filter" type="text">' +
        '   <div class="btn-group buttons">' +
        '     <button id="myButton" type="button" class="btn remove"></button>' +
        '     <button id="myButton" type="button" class="btn removeall"></button>' +
        '   </div>' +
        '   <select multiple="multiple"></select>' +
        ' </div>' +
        '</div>')
