...
{
    public class DttypesGroupsController : Controller
    {
        private readonly EISDBContext _context;

        public DttypesGroupsController(EISDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            return View(await _context.DttypesGroup.Where(a=>a.LineId.Trim()==LineID).ToListAsync());
        }

        // GET: DttypesGroups/Create
        public IActionResult Create()
        {
            ...
            #endregion
            ViewData["LineID"] = LineID;
            DttypesGroup dttypesGroup = new DttypesGroup()
            {
                Description = "Sor állási oka",
                DescriptionEn = "Reason for production line shutdown",
                LineId = LineID,
                DtgroupId = 0
            };
            return PartialView("_CreateModalPartion", dttypesGroup);
        }

        // POST: DttypesGroups/Create
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("DtgroupId,LineId,Description,DescriptionEn,Id")] DttypesGroup dttypesGroup)
        {
            ViewData["LineID"] = dttypesGroup.LineId;
            if (ModelState.IsValid)
            {
                _context.Add(dttypesGroup);
        ...
        // GET: DttypesGroups/Edit/5
        public async Task<IActionResult> Edit(int? id)
        {
            if (id == null || _context.DttypesGroup == null)
            {
                return NotFound();
            }

            var dttypesGroup = await _context.DttypesGroup.FindAsync(id);
            if (dttypesGroup == null)
            {
                return NotFound();
            }
            ViewData["LineID"] = dttypesGroup.LineId;
            return PartialView("_EditModalPartion", dttypesGroup);
        }

        // POST: DttypesGroups/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DtgroupId,LineId,Description,DescriptionEn,Id")] DttypesGroup dttypesGroup)
        {
            if (id != dttypesGroup.Id)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    _context.Update(dttypesGroup);
                    await _context.SaveChangesAsync();
                }
                catch (DbUpdateConcurrencyException)
                {
                    if (!DttypesGroupExists(dttypesGroup.Id))
                    {
                        return NotFound();
                    }
                    else
        ...
        private bool DttypesGroupExists(int id)
        {
          return _context.DttypesGroup.Any(e => e.Id == id);
        }
    }
}
