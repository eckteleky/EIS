...
{
    public class LzCompetencyController : Controller
    {
        private readonly EISDBContext _context;

        public LzCompetencyController(EISDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            #endregion
            var vl = await _context.GetLZCompetency(dolgozoid).ToListAsync();
            return View(vl);
        }
    }
}
