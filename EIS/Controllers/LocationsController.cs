...
namespace EIS.Controllers
{
    public class LocationsController : Controller
    {
        ...
        public LocationsController(EISDBContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Create()
        {
            ...
            return PartialView("_CreateModalPartion", location);
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Description")] Location location)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            return PartialView("_EditModalPartion", location);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description")] Location location)
        {
            if (id != location.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EISDBContext.Location'  is null.");
            }
            var location = await _context.Location.FindAsync(id);
            if (location != null)
            {
